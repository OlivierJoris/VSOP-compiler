...
{
       0,   138,   138,   142,   143,   146,   149,   154,   155,   157,
     161,   162,   165,   168,   169,   170,   171,   172,   175,   176,
     180,   181,   185,   188,   192,   193,   197,   198,   199,   200,
     201,   202,   203,   204,   205,   206,   207,   208,   209,   210,
     211,   212,   213,   214,   215,   216,   217,   218,   219,   220,
     221,   222,   225,   226,   229,   232,   233,   236,   237,   240,
     241,   245,   246,   247,   248,   251,   253,   255,   257,   259
};
#endif
...
#line 1958 "vsopc.tab.c"
    break;

  case 20: /* FormalsContinued: %empty  */
#line 180 "vsopc.y"
                        {(yyval.formals) = new Formals();}
#line 1964 "vsopc.tab.c"
    break;
...
#line 2153 "vsopc.tab.c"
    break;

  case 57: /* Args: %empty  */
#line 236 "vsopc.y"
            {(yyval.args) = new Args((yyloc).first_line, (yyloc).first_column);}
#line 2159 "vsopc.tab.c"
    break;
...
#line 237 "vsopc.y"
                            {(yyvsp[0].args)->addExpr((yyvsp[-1].expression)); 
                             (yyval.args) = (yyvsp[0].args);}
#line 2166 "vsopc.tab.c"
    break;

  case 59: /* ArgsExprList: %empty  */
#line 240 "vsopc.y"
                    {(yyval.args) = new Args((yyloc).first_line, (yyloc).first_column);}
#line 2172 "vsopc.tab.c"
    break;
...
#line 259 "vsopc.y"
                              {lexicalError(std::string("unexpected end-of-file without *) closing"));
                        YYERROR;}
#line 2238 "vsopc.tab.c"
    break;


#line 2242 "vsopc.tab.c"
