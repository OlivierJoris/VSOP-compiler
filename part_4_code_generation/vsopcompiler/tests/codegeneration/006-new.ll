; ModuleID = 'tests/codegeneration/006-new.vsop'
source_filename = "tests/codegeneration/006-new.vsop"
...
entry:
  ...
  %6 = call %Object* %5(%Object* %1, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @0, i64 0, i64 0))
  ret i32 0
}
