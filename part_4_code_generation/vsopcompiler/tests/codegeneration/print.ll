; ModuleID = 'tests/codegeneration/print.vsop'
source_filename = "tests/codegeneration/print.vsop"
...
entry:
  ...
  %3 = getelementptr inbounds %MainVTable, %MainVTable* %2, i32 0, i32 3
  %4 = load %Object* (%Object*, i8*)*, %Object* (%Object*, i8*)** %3, align 8
  %5 = bitcast %Main* %0 to %Object*
  %6 = call %Object* %4(%Object* %5, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @0, i32 0, i32 0))
  ret i32 0
}
