...
{
       0,   140,   140,   144,   145,   148,   151,   156,   157,   159,
     163,   164,   167,   170,   171,   172,   173,   174,   177,   178,
     182,   183,   187,   190,   194,   195,   199,   200,   201,   202,
     203,   204,   205,   206,   207,   208,   209,   210,   211,   212,
     213,   214,   215,   216,   217,   218,   219,   220,   221,   222,
     223,   224,   227,   228,   231,   234,   235,   238,   239,   242,
     243,   247,   248,   249,   250,   253,   255,   257,   259,   261
};
#endif
...
#line 148 "vsopc.y"
                                                     {std::vector<Field*> fields = (yyvsp[-1].classBody)->getFields();
                                                               ...
                                                               (yyval.cls) = new Class((yyvsp[-3].stringValue), "Object", fields, methods, (yyloc).first_line, (yyloc).first_column);}
...
#line 151 "vsopc.y"
                                                                                {std::vector<Field*> fields = (yyvsp[-1].classBody)->getFields();
                                                                                       std::vector<Method*> methods = (yyvsp[-1].classBody)->getMethods();
                                                                                       (yyval.cls) = new Class((yyvsp[-5].stringValue), (yyvsp[-3].stringValue), fields, methods, (yyloc).first_line, (yyloc).first_column);}
...
#line 159 "vsopc.y"
                           {(yyvsp[0].classBody)->addMethod((yyvsp[-1].method));
                                       (yyval.classBody) = (yyvsp[0].classBody);}
#line 1899 "vsopc.tab.c"
    break;

  case 10: /* Field: OBJECT_IDENTIFIER ":" Type ";"  */
#line 163 "vsopc.y"
                                              {(yyval.field) = new Field((yyvsp[-3].stringValue), (yyvsp[-1].stringValue), NULL, (yyloc).first_line, (yyloc).first_column);}
#line 1905 "vsopc.tab.c"
    break;

  case 11: /* Field: OBJECT_IDENTIFIER ":" Type "<-" Expr ";"  */
#line 164 "vsopc.y"
                                                             {(yyval.field) = new Field((yyvsp[-5].stringValue), (yyvsp[-3].stringValue), (yyvsp[-1].expression), (yyloc).first_line, (yyloc).first_column);}
#line 1911 "vsopc.tab.c"
    break;

  case 12: /* Method: OBJECT_IDENTIFIER "(" Formals ")" ":" Type Block  */
#line 167 "vsopc.y"
                                                            {(yyval.method) = new Method((yyvsp[-6].stringValue), (yyvsp[-4].formals), (yyvsp[-1].stringValue), new Block((yyvsp[0].args), (yyloc).first_line, (yyloc).first_column), (yyloc).first_line, (yyloc).first_column);}
#line 1917 "vsopc.tab.c"
    break;

  case 13: /* Type: TYPE_IDENTIFIER  */
#line 170 "vsopc.y"
                      {(yyval.stringValue) = (yyvsp[0].stringValue);}
#line 1923 "vsopc.tab.c"
    break;

  case 14: /* Type: "int32"  */
#line 171 "vsopc.y"
                      {(yyval.stringValue) = (char *) "int32";}
#line 1929 "vsopc.tab.c"
    break;

  case 15: /* Type: "bool"  */
#line 172 "vsopc.y"
                      {(yyval.stringValue) = (char *) "bool";}
#line 1935 "vsopc.tab.c"
    break;

  case 16: /* Type: "string"  */
#line 173 "vsopc.y"
                      {(yyval.stringValue) = (char *) "string";}
#line 1941 "vsopc.tab.c"
    break;
...
#line 187 "vsopc.y"
                                     {(yyval.formal) = new Formal((yyvsp[-2].stringValue), (yyvsp[0].stringValue), (yyloc).first_line, (yyloc).first_column);}
...
#line 194 "vsopc.y"
                 {(yyval.args) = new Args((yyloc).first_line, (yyloc).first_column);}
...
#line 1999 "vsopc.tab.c"
    break;

  case 29: /* Expr: OBJECT_IDENTIFIER "<-" Expr  */
#line 202 "vsopc.y"
                                        {(yyval.expression) = new Assign((yyvsp[-2].stringValue), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2005 "vsopc.tab.c"
    break;

  case 30: /* Expr: "not" Expr  */
#line 203 "vsopc.y"
                   {(yyval.expression) = new Not((yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2011 "vsopc.tab.c"
    break;

  case 31: /* Expr: Expr "and" Expr  */
#line 204 "vsopc.y"
                        {(yyval.expression) = new And((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2017 "vsopc.tab.c"
    break;

  case 32: /* Expr: Expr "<=" Expr  */
#line 205 "vsopc.y"
                                {(yyval.expression) = new LowerEqual((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2023 "vsopc.tab.c"
    break;

  case 33: /* Expr: Expr "<" Expr  */
#line 206 "vsopc.y"
                          {(yyval.expression) = new Lower((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2029 "vsopc.tab.c"
    break;

  case 34: /* Expr: Expr "=" Expr  */
#line 207 "vsopc.y"
                          {(yyval.expression) = new Equal((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2035 "vsopc.tab.c"
    break;

  case 35: /* Expr: Expr "-" Expr  */
#line 208 "vsopc.y"
                          {(yyval.expression) = new Minus((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2041 "vsopc.tab.c"
    break;

  case 36: /* Expr: Expr "+" Expr  */
#line 209 "vsopc.y"
                         {(yyval.expression) = new Plus((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2047 "vsopc.tab.c"
    break;

  case 37: /* Expr: Expr "/" Expr  */
#line 210 "vsopc.y"
                        {(yyval.expression) = new Div((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2053 "vsopc.tab.c"
    break;

  case 38: /* Expr: Expr "*" Expr  */
#line 211 "vsopc.y"
                          {(yyval.expression) = new Times((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2059 "vsopc.tab.c"
    break;

  case 39: /* Expr: Expr "^" Expr  */
#line 212 "vsopc.y"
                        {(yyval.expression) = new Pow((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2065 "vsopc.tab.c"
    break;

  case 40: /* Expr: "-" Expr  */
#line 213 "vsopc.y"
                                      {(yyval.expression) = new UnaryMinus((yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2071 "vsopc.tab.c"
    break;

  case 41: /* Expr: "isnull" Expr  */
#line 214 "vsopc.y"
                      {(yyval.expression) = new IsNull((yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2077 "vsopc.tab.c"
    break;

  case 42: /* Expr: OBJECT_IDENTIFIER "(" Args ")"  */
#line 215 "vsopc.y"
                                           {(yyval.expression) = new Call(NULL, (yyvsp[-3].stringValue), (yyvsp[-1].args), (yyloc).first_line, (yyloc).first_column);}
#line 2083 "vsopc.tab.c"
    break;

  case 43: /* Expr: Expr "." OBJECT_IDENTIFIER "(" Args ")"  */
#line 216 "vsopc.y"
                                                    {(yyval.expression) = new Call((yyvsp[-5].expression), (yyvsp[-3].stringValue), (yyvsp[-1].args), (yyloc).first_line, (yyloc).first_column);}
#line 2089 "vsopc.tab.c"
    break;

  case 44: /* Expr: "new" TYPE_IDENTIFIER  */
#line 217 "vsopc.y"
                              {(yyval.expression) = new New((yyvsp[0].stringValue), (yyloc).first_line, (yyloc).first_column);}
#line 2095 "vsopc.tab.c"
    break;

  case 45: /* Expr: OBJECT_IDENTIFIER  */
#line 218 "vsopc.y"
                            {(yyval.expression) = new ObjectIdentifier((yyvsp[0].stringValue), (yyloc).first_line, (yyloc).first_column);}
#line 2101 "vsopc.tab.c"
    break;

  case 46: /* Expr: "self"  */
#line 219 "vsopc.y"
               {(yyval.expression) = new Self((yyloc).first_line, (yyloc).first_column, new ObjectIdentifier("self", (yyloc).first_line, (yyloc).first_column));}
#line 2107 "vsopc.tab.c"
    break;

  case 48: /* Expr: "(" ")"  */
#line 221 "vsopc.y"
                    {(yyval.expression) = new Unit((yyloc).first_line, (yyloc).first_column);}
#line 2113 "vsopc.tab.c"
    break;

  case 49: /* Expr: "(" Expr ")"  */
#line 222 "vsopc.y"
                         {(yyval.expression) = (yyvsp[-1].expression);}
#line 2119 "vsopc.tab.c"
    break;

  case 50: /* Expr: Block  */
#line 223 "vsopc.y"
                {(yyval.expression) = new Block((yyvsp[0].args), (yyloc).first_line, (yyloc).first_column);}
#line 2125 "vsopc.tab.c"
    break;

  case 52: /* If: "if" Expr "then" Expr  */
#line 227 "vsopc.y"
                      {(yyval.expression) = new If((yyvsp[-2].expression), (yyvsp[0].expression), NULL, (yyloc).first_line, (yyloc).first_column);}
#line 2131 "vsopc.tab.c"
    break;

  case 53: /* If: "if" Expr "then" Expr "else" Expr  */
#line 228 "vsopc.y"
                                      {(yyval.expression) = new If((yyvsp[-4].expression), (yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2137 "vsopc.tab.c"
    break;

  case 54: /* While: "while" Expr "do" Expr  */
#line 231 "vsopc.y"
                          {(yyval.expression) = new While((yyvsp[-2].expression), (yyvsp[0].expression), (yyloc).first_line, (yyloc).first_column);}
#line 2143 "vsopc.tab.c"
    break;

  case 55: /* Let: "let" OBJECT_IDENTIFIER ":" Type "in" Expr  */
#line 234 "vsopc.y"
                                              {(yyval.expression) = new Let((yyvsp[-4].stringValue), (yyvsp[-2].stringValue), (yyvsp[0].expression), NULL, (yyloc).first_line, (yyloc).first_column);}
#line 2149 "vsopc.tab.c"
    break;

  case 56: /* Let: "let" OBJECT_IDENTIFIER ":" Type "<-" Expr "in" Expr  */
#line 235 "vsopc.y"
                                                               {(yyval.expression) = new Let((yyvsp[-6].stringValue), (yyvsp[-4].stringValue), (yyvsp[0].expression), (yyvsp[-2].expression), (yyloc).first_line, (yyloc).first_column);}
...
#line 243 "vsopc.y"
                                  {(yyvsp[0].args)->addExpr((yyvsp[-1].expression));
                                   (yyval.args) = (yyvsp[0].args);}
#line 2181 "vsopc.tab.c"
    break;

  case 61: /* Literal: INTEGER_LITERAL  */
#line 247 "vsopc.y"
                         {(yyval.expression) = new IntegerLiteral((yyvsp[0].intValue), (yyloc).first_line, (yyloc).first_column);}
#line 2187 "vsopc.tab.c"
    break;

  case 62: /* Literal: STRING_LITERAL  */
#line 248 "vsopc.y"
                         {(yyval.expression) = new StringLiteral((yyvsp[0].stringValue), (yyloc).first_line, (yyloc).first_column);}
#line 2193 "vsopc.tab.c"
    break;

  case 63: /* Literal: "true"  */
#line 249 "vsopc.y"
               {(yyval.expression) = new BooleanLiteral(true, (yyloc).first_line, (yyloc).first_column);}
#line 2199 "vsopc.tab.c"
    break;

  case 64: /* Literal: "false"  */
#line 250 "vsopc.y"
                {(yyval.expression) = new BooleanLiteral(false, (yyloc).first_line, (yyloc).first_column);}
...
#line 261 "vsopc.y"
                              {lexicalError(std::string("unexpected end-of-file without *) closing"));
                        YYERROR;}
#line 2240 "vsopc.tab.c"
    break;


#line 2244 "vsopc.tab.c"
